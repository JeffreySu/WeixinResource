...
real name(if it's supported). So, please let us know while your name is missing in the contributors' list:  https://github.com/JeffreySu/WeixinResource/blob/master/Contributor.md
